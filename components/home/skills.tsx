	...
	const renderSkillColumn = useCallback(
		(title: string, skills: string[]): React.ReactNode => {
			...
			return (
				<div
					key={title}
					className="skill-card p-6 rounded-2xl border border-gray-800/50 bg-gray-900/30 backdrop-blur-sm hover:border-[#219190]/30 transition-all duration-[10ms] relative overflow-hidden"
				>
					{/* Gradient accent line at top */}
					<div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-[#219190] via-[#57C785] to-[#219190] opacity-40" />

					{/* Category header with icon */}
					<div className="flex items-center gap-2 mb-4">
						{Icon && (
							<div className="w-5 h-5 rounded bg-[#219190]/10 flex items-center justify-center flex-shrink-0">
								<Icon className="w-3 h-3 text-[#57C785]" />
							</div>
						)}
