...
const IdeTestimonialsSection = () => {
	...
	return (
		...
		>
			...
			<div
				ref={cardRef}
				className="ide-window rounded-2xl overflow-hidden bg-gray-900/80 backdrop-blur-sm border border-gray-800/50 transition-all duration-[10ms] hover:border-[#219190]/40 hover:shadow-[0_20px_40px_-12px_rgba(33,145,144,0).15)]"
			>
				{/* Title bar */}
				<div className="flex items-center gap-3 px-4 py-3 border-b border-gray-800/70 bg-gray-900/60">
					...
					<div className="ml-auto flex items-center gap-2">
						<button
							...
							className="lg:hidden flex items-center gap-1.5 font-mono text-xs text-[#57C785] hover:text-white transition-colors duration-[10ms]"
						...
						<button
							...
							className="font-mono text-[10px] text-[#57C785] border border-[#219190]/30 rounded px-1.5 py-0.5 hover:text-white hover:border-[#219190]/60 transition-all duration-[10ms]"
				...
				<div className="flex items-center border-t border-gray-800/70 bg-gray-950/80 font-mono text-[11px] text-gray-300 overflow-hidden">
					<button
						...
						className="flex items-center gap-1.5 px-3 py-1.5 bg-[#219190] text-white hover:bg-[#1F5673] transition-colors duration-[10ms]"
					...
					<span className="ml-auto hidden sm:flex items-center py-1.5">
						{activeFile && (
							<span className="px-3 text-[#57C785]">
			...
			<div className="mt-6 flex flex-wrap justify-center items-center gap-x-3 gap-y-2">
				<a
					...
					className="text-[#57C785] text-md underline hover:text-white transition-colors"
					target="_blank"
					rel="noreferrer"
					onClick={() =>
