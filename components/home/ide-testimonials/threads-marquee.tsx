		...
		return (
			<button
				...
				className={`theme-card flex-shrink-0 w-64 text-left p-4 rounded-2xl border backdrop-blur-sm transition-all duration-[10ms] ${
					mentionedByCurrent
						? "bg-gray-800/80 border-[#219190]/60 shadow-lg shadow-[#219190]/10"
						: "bg-gray-800/50 border-gray-700/50 hover:border-[#219190]/40 hover:bg-gray-800/70"
				}`}
			>
						...
						return (
							<Image
								...
								className={`w-7 h-7 rounded-full object-cover border-2 ${
									isCurrent ? "border-[#219190]" : "border-gray-900"
								}`}
								loading="lazy"
							/>
						);
