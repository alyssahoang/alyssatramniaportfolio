		...
		<div className="grid md:grid-cols-2">
			...
			<div className="p-6 md:p-8 flex flex-col justify-center">
				<div className="flex items-center flex-wrap gap-2 mb-4 text-xs font-medium uppercase tracking-wide text-gray-400">
					<span className="normal-case tracking-normal text-[#57C785] bg-[#219190]/15 border border-[#219190]/20 rounded-full px-2.5 py-0.5">
						Featured
					</span>
				...
				<h4 className="font-bold text-white group-hover:text-[#57C785] transition-colors duration-[10ms] leading-tight text-2xl md:text-4xl">
					{article.title}
				</h4>
		...
		>
			...
			{featured && (
				<a
					...
					rel="noreferrer"
					data-read-card
					className="group block rounded-2xl overflow-hidden bg-gray-900/80 backdrop-blur-sm border border-gray-800/50 transition-all duration-[10ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:border-[#219190]/40 hover:shadow-[0_20px_40px_-12px_rgba(33,145,144,0).15)] hover:-translate-y-1"
					onClick={() => {
				...
				<div className="grid md:grid-cols-2 gap-6 mt-6 md:mt-8">
					{rest.map((article, index) => (
						<a
							...
							rel="noreferrer"
							data-read-card
							className="group block h-full rounded-2xl overflow-hidden bg-gray-900/80 backdrop-blur-sm border border-gray-800/50 transition-all duration-[10ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:border-[#219190]/40 hover:shadow-[0_20px_40px_-12px_rgba(33,145,144,0).15)] hover:-translate-y-1"
							onClick={() => {
