...
const PANEL_CLASSES =
	"w-full rounded-2xl p-6 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 shadow-xl hover:border-[#219190]/30 hover:shadow-[0_0_30px_-5px_rgba(33,145,144,0).15)] transition-all duration-[10ms]";
	...
	const StatCard = ({ icon, label, value }: { icon: React.ReactNode; label: string; value: number }) => (
		<a
			...
			style={{
				...
				border: '1px solid rgba(33, 145, 144, 0.15)',
			}}
		>
			<div className="text-2xl mb-2 text-[#219190]">{icon}</div>
	...
	return (
		<div ref={containerRef} className={PANEL_CLASSES}>
			...
			>
				...
				<img
					src={`https://ghchart.rshah.org/219190/${GITHUB_USERNAME}`}
