	...
	return (
		<section className="w-full relative select-none" ref={targetSection}>
			<div className="py-16 sm:py-24 md:py-36 tall:py-30 section-container relative">
				...
				<span
					aria-hidden="true"
					className="quote-ghost absolute -top-2 left-2 md:left-10 text-[8rem] md:text-[12rem] leading-none font-bold text-[#219190]/10 pointer-events-none"
				>
					&ldquo;
				</span>
				...
				<div
					aria-hidden="true"
					className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[24rem] h-[16rem] md:w-[30rem] md:h-[18rem] rounded-full bg-[#219190]/10 blur-3xl aurora-blob aurora-drift-3 pointer-events-none"
				/>
				...
				<div className="text-center relative">
					...
					<p className="quote-line mt-4 text-xl md:text-2xl text-gray-400">
						scroll down and <span className="text-[#57C785] font-bold">see what I mean</span>
					</p>
					<div className="quote-line mt-8 flex justify-center" aria-hidden="true">
						<svg
							className="chevron-bounce w-6 h-6 text-[#57C785]"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
							strokeWidth="2"
