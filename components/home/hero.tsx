	...
	const renderBackgroundImage = (): React.ReactNode => (
		<div ref={bgWrapperRef} className={HERO_STYLES.BG_WRAPPER} style={{ maxHeight: "650px" }}>
			<div
				...
				style={{
					background: "radial-gradient(circle, rgba(33, 145, 144, 0.15) 0%, transparent 70%)",
					filter: "blur(60px)",
				}}
			/>
			<HeroImage />
		...
		<div ref={contentRef} className={HERO_STYLES.CONTENT}>
			...
			<div className="flex flex-wrap gap-4 seq mt-6">
				<a
					...
					className="inline-flex items-center gap-3 px-5 py-3 bg-[#219190] hover:bg-[#1F5673] text-white text-base font-medium rounded-full transition-all duration-[10ms] hover:shadow-lg hover:shadow-[#219190]/25 hover:-translate-y-0.5"
				>
