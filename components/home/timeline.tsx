		...
		return (
			...
			>
				...
				<div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px transform md:-translate-x-1/2">
					...
					<div
						className="timeline-rail-seg absolute inset-0 bg-gradient-to-b from-[#219190]/70 via-[#219190]/40 to-[#219190]/10"
						aria-hidden="true"
					></div>
					{/* Dot */}
					<div className="timeline-dot absolute top-8 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gray-900 border-2 border-[#219190] rounded-full z-10 timeline-dot-glow"></div>
				</div>
				...
				>
					...
					>
						<span className="inline-block text-[#57C785] text-lg font-semibold mb-2">
							{experience.date}
						</span>
						<h4
						...
						{experience.techStack && experience.techStack.length > 0 && (
							...
							>
								{experience.techStack.map((tech) => (
									<span
										key={tech.name}
										className="group relative flex items-center justify-center w-8 h-8 rounded-lg bg-gray-800/80 border border-gray-700/60 p-1.5 transition-all duration-[10ms] hover:border-[#219190]/50 hover:bg-gray-800"
									>
										...
										<img
											...
											loading="lazy"
										/>
										<span className="pointer-events-none absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-gray-900 border border-[#219190]/30 px-2 py-0.5 text-xs text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-[10ms] z-20">
											{tech.name}
										</span>
									</span>
								))}
						...
						{experience.location && (
							<span className={`inline-flex items-center gap-1.5 mt-3 px-3 py-1 rounded-full text-sm font-medium bg-gray-800/80 text-gray-200 ${isEven ? "md:ml-auto" : ""}`}>
								<svg className="w-3.5 h-3.5 text-[#219190]" fill="currentColor" viewBox="0 0 20 20">
					...
					>
						{experience.companyUrl ? (
							...
							>
								<div className="relative w-full max-w-sm mx-auto aspect-video rounded-xl overflow-hidden shadow-2xl bg-gray-800 transform transition-all duration-[10ms] group-hover:scale-[1.02] group-hover:shadow-[0_20px_40px_-12px_rgba(33,145,144,0).15)]">
									<Image
								...
								{/* Decorative border */}
								<div className="absolute -inset-1 bg-gradient-to-r from-[#219190]/20 to-yellow-600/20 rounded-xl blur-sm -z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-[10ms]"></div>
							</a>
						) : (
