			...
			>
				<defs>
					<linearGradient id={`wave-grad-${flip ? "flip" : "normal"}`} x1="0%" y1="0%" x2="100%" y2="0%">
						<stop offset="0%" stopColor="rgba(33, 145, 144, 0)" />
						<stop offset="30%" stopColor="rgba(33, 145, 144, 0.12)" />
						<stop offset="50%" stopColor="rgba(87, 199, 133, 0.15)" />
						<stop offset="70%" stopColor="rgba(33, 145, 144, 0.12)" />
						<stop offset="100%" stopColor="rgba(33, 145, 144, 0)" />
					</linearGradient>
				</defs>
