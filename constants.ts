...
export const PROJECTS: IProject[] = [
	...
	},
	{
		...
		description: "A Power BI walk-through of AdventureWorks' production and stock flows, from the first bottleneck to the cost hiding behind it.",
		...
		fullDescription: "Inventory problems rarely announce themselves. I modelled AdventureWorks' production and inventory data in Power Query and Power BI, then designed a dashboard that walks from plant throughput to stock imbalances to the costs behind them, so planning conversations start from the same picture.",
		impact: ["Bottlenecks made visible", "Stock imbalances by product line", "One shared view for planning"],
		featured: true,
	},
	{
...
export const TIMELINE: Array<TimelineNodeV2> = [
	...
	},
	{
		...
		size: ItemSize.SMALL,
		subtitle: "A second master's, this time through an economics and health lens",
	...
	},
	{
		...
		size: ItemSize.SMALL,
		subtitle: "Master's in data science and business analytics · GPA 4.5/5",
